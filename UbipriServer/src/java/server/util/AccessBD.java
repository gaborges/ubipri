...
public class AccessBD {    
    ...
    /**
     *
     * @param Contrutor com parâmetros: (endereço do Servidor, nome do bando de dados, nome do usuário, senha do usuário);
     * @return ao instanciar já insere os dados para conexão com o banco de dados
     */
     ...
     *
     * @param
     * @return Estabelece conexão com banco de dados.
     */
     ...
     *
     * @param
     * @return Desconecta do banco de dados.
     */
    ...
    /**
     *
     * @param parâmetros: (endereço do Servidor, nome do bando de dados, nome do usuário, senha do usuário);
