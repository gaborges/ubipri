        ...
        <div class="container">
            ...
            <div class="list">
                    ...
                    <form action="remove.jsp" method="get"  onSubmit="return confirmSubmit()">
                        <tbody>
                            <%
                                ...
                                ArrayList<DeviceType> devicetypes = devtypeDAO.getList();

                                DeviceType devtype;

                                for (int i = 0; i < devicetypes.size(); i++) {
                                    devtype = devicetypes.get(i);%>
                            <tr>
                                <td class="check"><input  type="checkbox" name="check" value="<%=devtype.getId()%>" /></td>
                                <td><%=devtype.getId()%></td>
                                <td><%=devtype.getName()%></td>
                                <td><a href="update.jsp?id=<%=devtype.getId()%>">Update</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                </table>
                ...
                <form name="form_incluir" action="form.jsp" class="inline">
                    <input type="submit" value="New Device Type" name="new"/>
                </form>
            </div>
        </div>
    </body>
