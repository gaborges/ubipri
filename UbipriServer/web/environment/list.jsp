        ...
        <div class="container">
            ...
            <div class="list">
                <table  id="tablepaging">
                    ...
                    <th><p>Longitude</p></th>
                    <th><p>Atitude</p></th>
                    <th><p>Operating Range</p></th>
                    <th><p>Version</p></th>
                    <th><p>Parent</p></th>
                    <th><p>Environment Type</p></th>
                    <th><p>Localization Type</p></th>
                    <th><p>Update</p></th>
                    </tr>
                    </thead>
                    <form action="remove.jsp" method="get"  onSubmit="return confirmSubmit()">
                        <tbody>
                            ...
                            <tr>
                                <td class="check"><input  type="checkbox" name="check" value="<%=env.getId()%>" /></td>
                                <td><%=env.getId()%></td>
                                <td><%=env.getName()%></td>
                                <td><%=env.getLatitude()%></td>
                                <td><%=env.getLongitude()%></td>
                                <td><%=env.getAltitude()%></td>
                                <td><%=env.getOperatingRange()%></td>
                                <td><%=env.getVersion()%></td>
                                <td><%=env.getParentEnvironment().getName()%></td>
                                <td><%=env.getEnvironmentType().getName()%></td>
                                <td><%=env.getLocalizationType().getName()%></td>
                                <td><a href="update.jsp?id=<%=env.getId()%>">Update</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                </table>
                ...
                <form name="form_incluir" action="form.jsp" class="inline">
                    <input type="submit" value="New Environment" name="new"/>
                </form>
            </div>
        </div>
    </body>
