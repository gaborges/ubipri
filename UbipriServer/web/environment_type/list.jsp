...
<html>
    <head>
        ...
        <title>Environment Type List</title>
    </head>
        ...
        <div class="container">
            ...
            <div class="list">
                    ...
                    <form action="remove.jsp" method="get"  onSubmit="return confirmSubmit()">
                        <tbody>
                            <%
                                ...
                                ArrayList<EnvironmentType> localizationtypes = envDAO.getList();

                                EnvironmentType env;

                                for (int i = 0; i < localizationtypes.size(); i++) {
                                    env = localizationtypes.get(i);%>
                            <tr>
                ...
                <form name="form_incluir" action="form.jsp" class="inline">
                    <input type="submit" value="New Environment Type" name="new"/>
                </form>
            </div>
        </div>
    </body>
