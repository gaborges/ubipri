        ...
        <div class="container">
            ...
            <div  class="list">
                    ...
                    <form action="remove.jsp" method="get"  onSubmit="return confirmSubmit()">
                        <tbody>
                            <%
                                ...
                                ArrayList<UserType> functionalities = usertypeDAO.getList();

                                UserType usertype;

                                for (int i = 0; i < functionalities.size(); i++) {
                                    usertype = functionalities.get(i);%>
                            <tr>
                                <td class="check"><input  type="checkbox" name="check" value="<%=usertype.getId()%>" /></td>
                                <td><%=usertype.getId()%></td>
                                <td><%=usertype.getName()%></td>
                                <td><a href="update.jsp?id=<%=usertype.getId()%>">Update</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                </table>
                ...
                <form name="form_incluir" action="form.jsp" class="inline">
                    <input type="submit" value="New User Type" name="new"/>
                </form>
            </div>
    </body>
