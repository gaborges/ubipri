...
<html>
    ...
    <head>
        ...
        <title>CommunicationType List</title>
    </head>
        ...
        <div class="container">
            ...
            <div  class="list">
                    ...
                    <form action="remove.jsp" method="get"  onSubmit="return confirmSubmit()">
                        <tbody>
                            <%
                                ...
                                ArrayList<CommunicationType> functionalities = commDAO.getList();

                                CommunicationType comm;

                                for (int i = 0; i < functionalities.size(); i++) {
                                    comm = functionalities.get(i);%>
                            <tr>
                                <td class="check"><input  type="checkbox" name="check" value="<%=comm.getId()%>" /></td>
                                <td><%=comm.getId()%></td>
                                <td><%=comm.getName()%></td>
                                <td><a href="update.jsp?id=<%=comm.getId()%>">Update</a></td>
                            </tr>
                            <%}%>
                        </tbody>
                </table>
                ...
                <form name="form_incluir" action="form.jsp" class="inline">
                    <input type="submit" value="New CommunicationType" name="new"/>
                </form>
            </div>
        </div>
    </body>
